...
(test (calc-c (esvacio? a1)) #f)
(test (calc-c (contiene? a1 1)) #t)
(test (calc-c (agrega-c a1 9)) (cjto '(1 7 2 9)))
(test (calc-c (agrega-c a1 666)) (cjto '(1 7 2 9 666)))
(test (calc-c (union a1 b2)) (cjto '(1 7 2 9 3 4)))
(test (calc-c (interseccion a1 b2)) (cjto '(1 2)))
(test (calc-c (diferencia (cjto '(1 2 4 6 7 8 9)) (cjto '(1 2 4 6)))) (cjto '(7 8 9)))
(test (calc-c (diferencia (cjto '(1 2 3)) (cjto '(2 3 4)))) (cjto '(1)))
(test (calc-c (diferencia (cjto '(3 2 4)) (cjto '(1 2 3)))) (cjto '(4)))
