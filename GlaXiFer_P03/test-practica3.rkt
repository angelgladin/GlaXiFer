...
(test (parse '(sqrt 2)) (op sqrt (list(num 1))))
...
(test (parse '(modulo 666 2)) (op modulo (list (num 666) (num 2))))   
(test (parse '(min 666 2 666 0)) (op min (list (num 666) (num 666) (num 666) (num 0))))
(test (parse '(max 666 2 666 0)) (op max (list (num 666) (num 666) (num 666) (num 0))))  
;;(op  (list (num 1) (num 2) (num 2) (num 2)))
(test (parse '(expt 2 2)) (op max (op expt (list (num 2) (num 2)))))  
...
(test (parse '{with {a 666} {with {b 0} {+ a b}}}) (with (list (binding 'a (num 666)))
      (with (list (binding 'b (num 0))) (op + (list (id 'a) (id 'b))))))

(test (parse '{with {a 666} {with {b a} {with {c 1} {+ a b c}}}})
      (with (list (binding 'a (num 666))) (with (list (binding 'b (id 'a)))
                                          (with (list (binding 'c (num 1))) (op + (list (id 'a) (id 'b) (id 'c)))))))

(test (parse '{with* {{a 0} {b a}} {+ b b}})
      (with* (list (binding 'a (num 0)) (binding 'b (id 'a))) (op + (list (id 'b) (id 'b)))))

(test (parse '{with* {{a 0} {b 1}} {+ a b}})
       (with* (list (binding 'a (num 0)) (binding 'b (id 1))) (op + (list (id 'a) (id 'b)))))

(test (parse '{with* {{a 0} {b 1} {c 2}} {+ a b c}})
