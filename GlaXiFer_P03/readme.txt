...
La primitiva es Lexer. Lo que hace lexer es produce una función que toma un input-port, empareja los patrones “re” contra 
el búfer y devuelve el resultado de ejecutar la accion-expr correspondiente. Cuando varios patrones coinciden, un lexer
elegirá el partido más largo, rompiendo los lazos en favor de la regla que aparece primero.

Es útil para el análisis léxico ya que solo guardamos las palabras, como hacer un trim, y emparejamos (comparamos) que 
