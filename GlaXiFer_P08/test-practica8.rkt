...
#| Módulo para pruebas unitarias de la práctica 8 |#
...
;; Pruebas para  interp
(test/exn (interp (desugar (parse 'foo)) (mtSub) (mtSto)) "lookup: Free identifier")
(test (interp (desugar (parse '1729)) (mtSub) (mtSto)) (numV 1729))
(test (interp (desugar (parse 'true)) (mtSub) (mtSto)) (boolV #t))
(test (interp (desugar (parse '{/= 1 2 3 4 5})) (mtSub) (mtSto)) (boolV #t))
(test (interp (desugar (parse '{if true true false})) (mtSub) (mtSto)) (boolV #t))
(test (interp (desugar (parse '{if {/= 2 2} true false})) (mtSub) (mtSto)) (boolV #f))
(test (interp (desugar (parse '{cond {true 1} {true 2} {else 3}})) (mtSub) (mtSto)) (numV 1))
(test (interp (desugar (parse '{with {{a 2} {b 3}} {+ a b}})) (mtSub) (mtSto)) (numV 5))
(test (interp (desugar (parse '{with {{a 666} {b {/ 1 0}}} {+ a 0}})) (mtSub) (mtSto)) (numV 666))
(test (exprV? (interp (desugar (parse '{with {{a {+ 1 1}}} a})) (mtSub) (mtSto))) #t)
(test (exprV? (interp (desugar (parse '{with* {{a 2} {b {+ a a}}} b})) (mtSub) (mtSto))) #t)
(test (interp (desugar (parse '{fun {x} {+ x 2}})) (mtSub) (mtSto)) (closureV '(x) (op + (list (id 'x) (num 2))) (mtSub)))
(test (interp (desugar (parse '{{fun {a b} {+ a b}} {2 3}})) (mtSub) (mtSto)) (numV 5))
(test (interp (desugar (parse '{or {not true} false})) (mtSub) (mtSto)) (boolV #f))
